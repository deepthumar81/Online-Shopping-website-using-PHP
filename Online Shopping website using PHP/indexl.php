...
<body class="" style="background-image: url('Images/download.svg');">
    ...
    <form class=" flex justify-center" name="form" method="post" id="form" action="login.php">
        <div class="w-3/6 my-20 bg-hero-white shadow-lg shadow-slate-900 px-10 py-5 rounded-md ">
                    ...
                    <div class=" grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 ">
                        <div class="col-span-full">
                            <label for="email-name"
                                class="block text-sm px-0.5 font-medium leading-6 text-gray-900">Email
                                Address</label>
                            <div class="mt-2">
                                <input type="text" name="email" id="email" placeholder="Enter email-address here..."
                                    class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-hero-blue sm:text-sm sm:leading-6">
                        ...
                        <div class="col-span-full">
                            <label for="password"
                                class="block text-sm font-medium px-0.5 leading-6 text-gray-900">Password</label>
                            <div class="mt-2">
            ...
            <div class="mt-4 mb-4 flex items-center justify-end gap-x-6">
                ...
                <button type="submit" name="submit" id="submit"
                    class="bg-[#eb364f] px-5 py-1.5 rounded-3xl text-base font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline ">Sign
                    In</button>
                <a href="account.php">
                    <button type="button"
                        class="bg-[#eb364f] px-5 py-1.5 rounded-3xl text-base font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline ">Create
                        Account</button>
                </a>
            </div>
        </div>
