...
<body class="" style="background-image: url('Images/download.svg');">
    ...
    <header class="h-16 bg-hero-white shadow-md sticky top-0">
        ...
        <nav class="relative px-2 pb-3 pt-1">
            ...
            <div class="container mx-auto my-auto flex justify-between items-center">
                ...
                <div class="flex space-x-3 ">
                    <a href="#" class="bg-hero-red px-5 py-2 rounded-3xl hover:bg-red-500 text-white text-base font-semibold hidden md:flex" role="button">Sign In</a>

                    <a href="#" class="bg-hero-red px-5 py-2 rounded-3xl hover:bg-red-500 text-white text-base font-semibold hidden md:flex" role="button">Login</a>
                </div>
                <!-- Mobile menu icon -->
    ...
    <form class=" flex justify-center" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
        <div class="w-3/6 my-20 bg-hero-white shadow-lg shadow-slate-900 px-10 py-5 rounded-md ">
            <div class="space-y-10">

                <div class="border-b border-gray-500/10 pb-10 m-2">
                    ...
                    <div class=" grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="col-span-full">
                            <label for="first-name" class="block text-sm font-medium leading-6 text-gray-900">Enter
                                Product Name</label>
                            <div class="mt-2">
                                <input type="text" name="product-name" id="product-name" placeholder="Enter product name here..." class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        ...
                        <div class="col-span-3">
                            ...
                            <div class="mt-2">
                                <select id="category" name="category" autocomplete="category-name" class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6">
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <textarea id="description" name="description" rows="3" placeholder="Enter product description here..." class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                            </div>
                        ...
                        <div class="col-span-full">
                            <label for="price" class="block text-sm font-medium leading-6 text-gray-900">Enter
                                Price</label>
                            <div class="mt-2">
                                <input type="text" name="price" id="price" autocomplete="given-name" placeholder="Enter product price here..." class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        <div class="col-span-full">
                            <label class="block mb-2 text-sm font-medium text-gray-900" for="file_input">Upload product
                                image</label>
                            <input class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 bg-white shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" id="image" name="image" type="file">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-4 mb-4 flex items-center justify-end gap-x-6">
                ...
                <button type="submit" name="submit" id="submit" class="bg-[#eb364f] px-5 py-1.5 rounded-3xl text-base font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline ">Submit</button>
            </div>
    </form>
    </div>

    <footer class="p-4 bg-hero-white sm:p-6">
        <div class="">
